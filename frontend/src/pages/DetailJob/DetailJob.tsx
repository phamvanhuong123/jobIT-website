              ...
              <div style={{ marginBottom: "40px", lineHeight: "1.7" }}>
                ...
                <ul style={{ paddingLeft: "20px", marginBottom: "12px" }}>
                  {jobData.reasons.map((reason, idx) => (
                    <li
                      key={idx}
                      style={{ listStyleType: '"●"', marginBottom: "8px" }}
                    >
                      {reason}
                    </li>
                  ))}
                ...
                <hr
                  style={{ borderTop: "1px dashed #ccc", margin: "24px 0" }}
                />
                ...
                <ul style={{ paddingLeft: "20px" }}>
                  ...
                  >
                    Thời gian làm việc, ngày phép, nghỉ phép:
                  </li>
            ...
            >
              ...
              >
                {[1, 2, 3, 4, 5].map((star) => {
                  ...
                  const isHalf =
                    jobData.company.rating >= star - 0.5 &&
                    jobData.company.rating < star;
                  return (
                    <span
                      key={star}
              ...
              <p style={{ fontStyle: "italic", margin: "10px 0" }}>
                Đồng hành cùng {jobData.company.name} trên chặng đường phủ sóng
                bản đồ số thế giới!
              </p>
